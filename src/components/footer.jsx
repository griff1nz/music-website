    ...
    return (
        <footer>
            ...
            <div className='footer-links'>
                ...
                <a href='tel:4844252044' target='_blank'><img src='https://static.vecteezy.com/system/resources/thumbnails/027/179/401/small/telephone-phone-call-icon-symbol-free-png.png' /></a>
            </div>
        </footer>
    )
}
