    ...
    return (
        <footer>
            ...
            <div className='footer-links'>
                <a href='https://www.facebook.com/GriffinWindsStrings/' target='_blank'><img src='https://cdn3.iconfinder.com/data/icons/transparent-on-dark-grey/500/icon-02-512.png' /></a>
