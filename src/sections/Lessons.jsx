    ...
    return (
        <>
            <div id='lessons' className='section' style={{ padding: '16px' }}>
                ...
                <p style={{ textAlign: 'center' }}><strong>Ready to begin?</strong> Go to the <a href='https://calendly.com/zion-isaac-griffin' target='_blank'>Calendly booking page</a> to book your first lesson, or email me directly for a lesson package!</p>
                <motion.div ref={ref}
                    variants={{
